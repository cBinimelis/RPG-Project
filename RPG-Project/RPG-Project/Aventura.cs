...
namespace RPG_Project
{
    public partial class Aventura : Form
    {
        ...
        int id_monster;                                                                     //Variables
        int vida_monster = 200;                                                             //Variables
        int lvl_monster;                                                                    //Variables
        int poder_monster;
        ...
        private void Aventura_FormClosing(object sender, FormClosingEventArgs e)
        {
        ...
        private void Aventura_Load(object sender, EventArgs e)
        {
            Cargar_Personaje();
            Cargar_Monstruo();
        ...
        //Carga del Monstruo
        public void Cargar_Monstruo()
        {
            //Asignar un valor al azar al id del monstruo
            id_monster = ran_number.Next(1, 11);


            //Seleccionar el montruo de la base de datos cono el indice al azar 
            SqlDataReader Monstruo = sql.consulta("Select * from Monster where id_monster='" + id_monster + "'");
            Monstruo.Read();


            //Configurar el monstruo en la Clase local
            Monster M = new Monster(Convert.ToInt32(Monstruo[0].ToString()), Monstruo[1].ToString(), Convert.ToInt32(Monstruo[2].ToString()), Convert.ToInt32(Monstruo[3].ToString()));
            Util.setMon(M);


            //Seleccionar el nombre del monstruo en relacion a su id
            lbl_monstruo.Text = Util.getMon().getNombre();

            //Elegir el nivel del Monstruo
            lvl_monster = ran_number.Next(1, (Util.getCharacter().getLvl() + 2));
            ...
            {
                case 1:
                    pic_monster.Image = RPG_Project.Properties.Resources.Slime;
                    break;
                case 2:
                    pic_monster.Image = RPG_Project.Properties.Resources.Pretty;
                    break;
                case 3:
                    pic_monster.Image = RPG_Project.Properties.Resources.Batter;
                    break;
                case 4:
                    pic_monster.Image = RPG_Project.Properties.Resources.Bug;
                    break;
                case 5:
                    pic_monster.Image = RPG_Project.Properties.Resources.Chicken;
                    break;
                case 6:
                    pic_monster.Image = RPG_Project.Properties.Resources.Eater;
                    break;
                case 7:
                    pic_monster.Image = RPG_Project.Properties.Resources.Fatguy;
                    break;
                case 8:
                    pic_monster.Image = RPG_Project.Properties.Resources.Hatty;
                    break;
                case 9:
                    pic_monster.Image = RPG_Project.Properties.Resources.Mutant;
                    break;
                case 10:
                    pic_monster.Image = RPG_Project.Properties.Resources.Gary;
                    break;
            }
        }
        ...
        public void Actualizar()
        {
            ...
            {
                vida_monster = 200;
                pb_lifeMonster.Value = 200;
                lbl_vidaMonster.Text = vida_monster.ToString();
            }
            else
            {
                if (vida_monster > 0)
                {
                    pb_lifeMonster.Value = vida_monster;
                    lbl_vidaMonster.Text = vida_monster.ToString();
                }
                else
                {
        ...
        public void Regenerar()
        {
            if (Vida_Maxima < 250)
            {
                Vida_Maxima += 2 * Util.getCharacter().getLvl();
            }
            else
            {
                Vida_Maxima = 250;
            ...
            if (Stamina_Maxima < 100)
            {
                Stamina_Maxima += 1 * Util.getCharacter().getLvl();
            }
            else
            {
                Stamina_Maxima = 100;
        ...
        {
            poder_monster= ran_number.Next(10,Util.getMon().getPoder()*5);
            lbl_habilidades.Text = Util.getMon().getNombre()+" ha atacado";
            Vida_Maxima = Vida_Maxima - poder_monster;
            Espera.Stop();
        }
        ...
        private void btn_ataque1_Click(object sender, EventArgs e)
        {
                if (Stamina_Maxima < Util.getAta1().getCoste() || (Stamina_Maxima - Util.getAta1().getCoste()) < 0)
                {
                    ...
                    vida_monster = vida_monster - (10 + ataquebasico);
                ...
                else
                {
                    ...
                    vida_monster = vida_monster - ataque1;
        ...
        private void btn_ataque2_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                vida_monster = vida_monster - ataque2;
        ...
        private void btn_ataque3_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                vida_monster = vida_monster - ataque3;
        ...
        private void btn_ataque4_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                vida_monster = vida_monster - ataque4;
